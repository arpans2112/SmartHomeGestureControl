...
public class PracticeGestureActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    private void start() {
        ...
        //Surface view
        mySurfaceView = (SurfaceView) findViewById(R.id.camera_surface_view);
        ...
        * */
        findViewById(R.id.btnUpload).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(), "Sending post Request", Toast.LENGTH_LONG).show();
                postRequest();
...
//        mRecorder.setOutputFormat(MediaRecorder.OutputFormat.MPEG_4);
    ...
    * */
    ...
    private static File getOutputMediaFile(int type) {
        ...
        mediaFileName = gestureNameToPractice  + "_PRACTICE_" + timeStamp + "_asaini23" +  ".mp4";

        mediaDirectory = mediaStorageDir.getPath();
